...
- [VMware8](http://www.zhufengpeixun.com/grow/html/VMware8)
### 4.2 虚拟机的主要特点
...
### 4.5 虚拟机使用
#### 4.5.1 新建虚拟机
- i. Create a New Virtual Machine开始新建虚拟机向导
- ii. 我以后再安装操作系统
...
#### 8.1.3 /etc/passwd
- 存储当前系统中所有用户的信息
- user:x:123:456:xxxxxx:/home/user:/bin/sh
- 用户名：密码占位符:用户编码:用户注释信息:用户主目录:shell类型
#### 8.1.4 /etc/shadow
- 存放当前系统中所有用户的密码信息
- user: xxx
- 用户名:密码:
