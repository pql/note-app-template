...
```
![](/public/images/fiber_shu_ju_jie_gou_1636706883352.png)

#### 1.1.2 构建和完成

![](/public/images/gou_jian_he_wan_cheng_fiber_shu_1_1636707293363.png)

#### 1.1.3 案例
![](/public/images/gou_jian_he_wan_cheng_fiber_shu_an_li_1_1636710450130.png)
...
![](/public/images/initializeUpdateQueue1_1636711483523.png)
![](/public/images/initializeUpdateQueue2_1636711495721.png)
![](/public/images/initializeUpdateQueue3_1636711676019.png)
![](/public/images/initializeUpdateQueue4_1636711685706.png)

### 1.3 位运算
#### 1.3.1 按位与(&)
- 两个输入数的同一位都为1才为1
![](/public/images/bitand2_1636888349506.png)
#### 1.3.2 按位或(|)
- 两个输入数的同一位只要有一个为1就是1
![](/public/images/bitor2_1636888357232.png)
```
...
- fiber节点构建完成的操作执行在`completeUnitOfWork`方法，在这个方法里，不仅会对节点完成构建，也会将有flags的Fiber节点添加到effectList

![](/public/images/collectEffectListINIT1_1637041097456.png)

![](/public/images/collectEffectList_wan_cheng_BBB_1637041894303.png)

![](/public/images/collectEffectList_wan_cheng_DD1_1637041983781.png)

![](/public/images/collectEffectList_wan_cheng_A_1637042074823.png)
...
![](images/render_dao_performSyncWorkOnRoot_1636637139987.png)

### 3.2 fiber结构
- [fiber结构](https://www.processon.com/diagraming/618d10607d9c08562ae923b9)

![](/public/images/cong_render_dao_zhi_xing_gong_zuo_xun_huan_fiber_shu_1636640422211.png)
...
![](/public/images/cong_render_dao_zhi_xing_gong_zuo_xun_huan_de_fiber_jia_gou_21_1636712927379.png)
...
![](/public/images/cong_render_dao_zhi_xing_gong_zuo_xun_huan_de_fiber_jia_gou_3_1636810005933.png)
...
![](/public/images/cong_render_dao_zhi_xing_gong_zuo_xun_huan_de_fiber_jia_gou_4_1636817909854.png)
![](/public/images/dan_jie_dian_diff_1636818669377.png)
...
![](/public/images/cong_render_dao_zhi_xing_gong_zuo_xun_huan_de_fiber_jia_gou_6_1636821326045.png)
...
![](/public/images/duo_jie_dian_diff_1637227736096.png)
![](/public/images/cong_render_dao_zhi_xing_gong_zuo_xun_huan_de_fiber_jia_gou_7_1636886355938.png)
...
![](/public/images/duo_ge_jie_dian_shu_liang_bu_tong_key_bu_tong_1_1637057627706.png)
