...
![](/public/images/design_chapter_1.jpg)
![](/public/images/design_chapter_2.jpg)
![](/public/images/design_chapter_3.jpg)

### 6.1 类图

![](/public/images/design_chapter_class.jpg)
...
- 装饰比继承更加灵活
### 7.1 类图
![](/public/images/design_decorate_class.png)
### 7.2 代码
```js
class Duck {
    eat(food) {
...
![](/public/images/design_aop_1.jpg)
![](/public/images/design_aop_2.jpg)
```js
...
### 8.1 类图
![](/public/images/design_proxy_class.png)
### 8.2 代码
```js
class Google {
    constructor() {}
...
![](/public/images/design_facede.png)
### 9.1 类图
![](/public/images/design_facede_class.png)
### 9.2 代码
```js
class Sum {
    sum(a, b) {
...
### 10.1 类图
![](/public/images/design_observer_class.png)
### 10.2 代码
```js
class Star {
    constructor(name) {
...
```
#### 10.3.7 生命周期函数
![](/public/images/design_lifecycle.jpg)
![](/public/images/design_lifecycle_vue.jpg)
#### 10.3.8 vue watch
```html
<body>
<div id="root">
...
- 使用者无需知道集合的内部数据结构
### 11.1 类图
![](/public/images/design_iterator_class.png)
### 11.2 代码
```js
...
- 用来减少 `if...else` 子句
### 12.1 类图
![](/public/images/design_status_class.png)
### 12.2 代码
```js
class Battery {
    constructor() {
...
### 13.1 类图
![](/public/images/design_strategy_class.png)
### 13.2 代码
```js
class Customer {
    constructor(type) {
...
### 14.1 类图
![](/public/images/design_prototype_class.jpg)
### 14.2 代码
```js
...
![](/public/images/design_prototype_1.png)
- 自定义函数的`prototype`是由`Object`创建，所以它的`proto`指向的就是`Object.prototype`
- `Object.prototype`的 `proto` 指向的是`null`
![](/public/images/design_prototype_2.png)
...
```
![](/public/images/design_prototype_3.png)
- Function.prototype的proto也指向Object.prototype
![](/public/images/design_prototype_4.png)
...
```
![](/public/images/design_prototype_5.png)
#### 14.3.4 原型链
...
### 15.1 类图
![](/public/images/design_bridge_class.png)
### 15.2 代码
```js
class A {
    constructor(bridge) {
...
### 16.1 类图
![](/public/images/design_compose_class.png)
### 16.2 代码
```html
<!DOCTYPE html>
<html lang="en">
...
### 17.1 类图
![](/public/images/design_command_class.png)
### 17.2 代码
```js
class Cooker {
    cook() {
...
### 18.1 类图
![](/public/images/design_sharedmeta_class.png)
### 18.2 代码
```js
...
- 好莱坞原则，子类放弃了控制权，改由父类来调用
    ...
    - 回调函数
### 19.1 类图
![](/public/images/design_template_class.png)
### 19.2 代码
```js
class Person{
    dinner() {
...
```
#### 19.3.2
![](/public/images/design_template_1.png)
...
- 将发起者和各个处理者进行隔离
### 20.1 类图
![](/public/images/design_duty_class.png)
### 20.2 代码
```js
class Employee{
    constructor(next) {
...
- 可以恢复之前的某个状态
### 21.1 类图
![](/public/images/design_memo_class.png)
### 21.2 代码
```html
...
## 22.中介者模式
### 22.1 类库
![](/public/images/design_intermediary_class.png)
### 22.2 代码
```js
class Boy{
...
### 23.2 类图
![](/public/images/design_visit_class.png)
### 23.3 代码
```js
class Father{
